...
func NewHeapableCircuitMinClonesLimited(vertices []model.CircuitVertex, deduplicator model.Deduplicator, perimeterBuilder model.PerimeterBuilder) *HeapableCircuitMinClonesLimited {
...
func (c *HeapableCircuitMinClonesLimited) FindNextVertexAndEdge() (model.CircuitVertex, model.CircuitEdge) {
