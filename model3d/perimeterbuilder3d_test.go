...
func TestBuildPerimeter_ShouldProduceSameResultAs2D(t *testing.T) {
	...
	assert.Equal(model3d.NewVertex3D(-15, -15, 0), circuit[0])
	assert.Equal(model3d.NewVertex3D(15, -15, 0), circuit[1])
	assert.Equal(model3d.NewVertex3D(9, 6, 0), circuit[2])
	assert.Equal(model3d.NewVertex3D(3, 13, 0), circuit[3])
	assert.Equal(model3d.NewVertex3D(-7, 6, 0), circuit[4])
...
func TestBuildPerimeter3D(t *testing.T) {
	...
	assert.Equal(model3d.NewVertex3D(-15, -15, 0), circuit[0])
	assert.Equal(model3d.NewVertex3D(15, -15, 5), circuit[1])
	...
	assert.Equal(model3d.NewVertex3D(8, 5, 4), circuit[2])
	assert.Equal(model3d.NewVertex3D(9, 6, -10), circuit[3])
	assert.Equal(model3d.NewVertex3D(3, 13, -16), circuit[4])
	assert.Equal(model3d.NewVertex3D(-7, 6, -8), circuit[5])
