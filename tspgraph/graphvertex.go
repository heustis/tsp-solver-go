...
func (g *GraphVertex) DistanceTo(other tspmodel.CircuitVertex) float64 {
	return g.EdgeTo(other).GetLength()
}

func (g *GraphVertex) EdgeTo(other tspmodel.CircuitVertex) tspmodel.CircuitEdge {
...
// PathToAll creates a map of the most efficient edges from this vertex to all other vertices in the tspgraph.
...
func (g *GraphVertex) PathToAll() map[tspmodel.CircuitVertex]tspmodel.CircuitEdge {
	edges := make(map[tspmodel.CircuitVertex]tspmodel.CircuitEdge)
...
func (g *GraphVertex) String() string {
	...
	h := tspmodel.NewHeap(func(a interface{}) float64 {
...
var _ tspmodel.CircuitVertex = (*GraphVertex)(nil)
