...
// Circuit provides an abstract representation of a set of points (locations, vertices) for the TSP tspsolver to interact with.
// This allows it to ignore whether the implementation is a set of N-dimentional points, a tspgraph, or any other representation of points.
...
// CircuitVertex provides an abstract representation of a single point (location, vertex) for the TSP tspsolver to interact with.
...
// CircuitVertex provides an abstract representation of an edge for the TSP tspsolver to interact with.
